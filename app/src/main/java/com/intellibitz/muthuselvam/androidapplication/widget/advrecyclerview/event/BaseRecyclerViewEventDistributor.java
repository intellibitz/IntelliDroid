...
public abstract class BaseRecyclerViewEventDistributor<T> {
    ...
    public boolean add(@NonNull T listener, int index) {
        ...
        if (!mListeners.contains(listener)) {
            ...
            if (listener instanceof com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.event.RecyclerViewEventDistributorListener) {
                ((com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.event.RecyclerViewEventDistributorListener) listener).onAddedToEventDistributor(this);
            }
        }
    ...
    public boolean remove(@NonNull T listener) {
        ...
        if (removed) {
            ...
            if (listener instanceof com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.event.RecyclerViewEventDistributorListener) {
                ((com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.event.RecyclerViewEventDistributorListener) listener).onRemovedFromEventDistributor(this);
            }
        }
