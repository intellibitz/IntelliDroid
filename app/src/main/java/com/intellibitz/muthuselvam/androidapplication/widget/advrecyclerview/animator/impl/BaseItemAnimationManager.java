...
public abstract class BaseItemAnimationManager<T extends ItemAnimationInfo> {
    ...
    protected static class BaseAnimatorListener implements ViewPropertyAnimatorListener {
        private com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.animator.impl.BaseItemAnimationManager mManager;
        private ItemAnimationInfo mAnimationInfo;
        private RecyclerView.ViewHolder mHolder;
        private ViewPropertyAnimatorCompat mAnimator;

        public BaseAnimatorListener(com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.animator.impl.BaseItemAnimationManager manager, ItemAnimationInfo info, RecyclerView.ViewHolder holder, ViewPropertyAnimatorCompat animator) {
            mManager = manager;
            mAnimationInfo = info;
            mHolder = holder;
            mAnimator = animator;
        ...
        public void onAnimationEnd(View view) {
            final com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.animator.impl.BaseItemAnimationManager manager = mManager;
