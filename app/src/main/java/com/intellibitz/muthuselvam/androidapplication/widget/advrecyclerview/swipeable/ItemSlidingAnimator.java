...
public class ItemSlidingAnimator {
    ...
    private static boolean slideInternalPreHoneycomb(
        ...
        if (!(holder instanceof com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.SwipeableItemViewHolder)) {
            return false;
        }

        final View containerView = ((com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.SwipeableItemViewHolder) holder).getSwipeableContainerView();
