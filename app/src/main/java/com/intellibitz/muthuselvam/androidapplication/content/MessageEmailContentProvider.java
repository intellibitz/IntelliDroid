...
import static com.intellibitz.muthuselvam.androidapplication.content.MsgEmailContactContentProvider.TABLE_MSGEMAILCONTACT_INTELLIBITZCONTACTS_JOIN;
...
public class MessageEmailContentProvider extends
    ...
    public static final String CREATE_TABLE_MESSAGESEMAIL_INDEX =
            "CREATE INDEX " +
                    TABLE_MESSAGESEMAIL + KEY_DATA_ID + DatabaseHelper.IDX +
                    " ON " +
                    TABLE_MESSAGESEMAIL + " (" +
                    KEY_DATA_ID + ")";
    ...
    public static String AUTHORITY =
            "com.intellibitz.muthuselvam.androidapplication.content.MessageEmailContentProvider";
...
*/
                        ...
                        "left outer join " + TABLE_MSGEMAILCONTACT_INTELLIBITZCONTACTS_JOIN +
