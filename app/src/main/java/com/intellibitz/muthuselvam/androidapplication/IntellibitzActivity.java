...
import com.intellibitz.muthuselvam.androidapplication.activity.AddEmailActivity;
import com.intellibitz.muthuselvam.androidapplication.activity.AddEmailsActivity;
import com.intellibitz.muthuselvam.androidapplication.activity.ClutterEmailActivity;
import com.intellibitz.muthuselvam.androidapplication.activity.ClutterEmailsActivity;
import com.intellibitz.muthuselvam.androidapplication.activity.ComposeEmailActivity;
import com.intellibitz.muthuselvam.androidapplication.activity.ContactSelectActivity;
import com.intellibitz.muthuselvam.androidapplication.activity.MessageChatGroupActivity;
import com.intellibitz.muthuselvam.androidapplication.activity.MsgChatGrpContactsDetailActivity;
import com.intellibitz.muthuselvam.androidapplication.activity.MsgsGrpDraftActivity;
import com.intellibitz.muthuselvam.androidapplication.activity.PeopleDetailActivity;
import com.intellibitz.muthuselvam.androidapplication.activity.ProfileActivity;
import com.intellibitz.muthuselvam.androidapplication.company.CompanyCreateActivity;
import com.intellibitz.muthuselvam.androidapplication.company.CompanyListActivity;
import com.intellibitz.muthuselvam.androidapplication.company.GetInvitesActivity;
import com.intellibitz.muthuselvam.androidapplication.company.InviteUsersActivity;
import com.intellibitz.muthuselvam.androidapplication.company.InviteUsersTask;
import com.intellibitz.muthuselvam.androidapplication.contact.ContactDetailActivity;
import com.intellibitz.muthuselvam.androidapplication.content.IntellibitzContactContentProvider;
import com.intellibitz.muthuselvam.androidapplication.content.MessageChatContentProvider;
import com.intellibitz.muthuselvam.androidapplication.content.MessageChatGroupContentProvider;
import com.intellibitz.muthuselvam.androidapplication.content.MessageEmailContentProvider;
import com.intellibitz.muthuselvam.androidapplication.content.MessagesChatContentProvider;
import com.intellibitz.muthuselvam.androidapplication.content.MessagesChatGroupContentProvider;
import com.intellibitz.muthuselvam.androidapplication.content.MsgChatGrpContactsContentProvider;
import com.intellibitz.muthuselvam.androidapplication.content.UserContentProvider;
import com.intellibitz.muthuselvam.androidapplication.content.UserEmailContentProvider;
...
import com.intellibitz.muthuselvam.androidapplication.db.ContactItemColumns;
import com.intellibitz.muthuselvam.androidapplication.db.MessageItemColumns;
import com.intellibitz.muthuselvam.androidapplication.domain.MainSettingsActivity;
import com.intellibitz.muthuselvam.androidapplication.domain.account.EmailAccountListActivity;
import com.intellibitz.muthuselvam.androidapplication.domain.help.IntroScreenActivity;
import com.intellibitz.muthuselvam.androidapplication.fragment.AttachmentsFragment;
import com.intellibitz.muthuselvam.androidapplication.fragment.DeviceContactsFragment;
import com.intellibitz.muthuselvam.androidapplication.fragment.IntellibitzContactsFragment;
import com.intellibitz.muthuselvam.androidapplication.fragment.MsgChatGrpContactsFragment;
import com.intellibitz.muthuselvam.androidapplication.fragment.MsgsGrpClutterFragment;
import com.intellibitz.muthuselvam.androidapplication.fragment.MsgsGrpPeopleChatGroupsFragment;
import com.intellibitz.muthuselvam.androidapplication.fragment.MsgsGrpPeopleChatsFragment;
import com.intellibitz.muthuselvam.androidapplication.fragment.MsgsGrpPeopleEmailsFragment;
import com.intellibitz.muthuselvam.androidapplication.fragment.MsgsGrpPeopleFragment;
import com.intellibitz.muthuselvam.androidapplication.gcm.GCMInstanceIDListenerService;
import com.intellibitz.muthuselvam.androidapplication.gcm.GCMTokenIntentService;
import com.intellibitz.muthuselvam.androidapplication.listener.ClutterListener;
import com.intellibitz.muthuselvam.androidapplication.listener.ClutterTopicListener;
import com.intellibitz.muthuselvam.androidapplication.listener.ContactListener;
import com.intellibitz.muthuselvam.androidapplication.listener.ContactsTopicListener;
import com.intellibitz.muthuselvam.androidapplication.listener.DeviceContactTopicListener;
import com.intellibitz.muthuselvam.androidapplication.listener.IntellibitzContactTopicListener;
import com.intellibitz.muthuselvam.androidapplication.listener.PeopleDetailListener;
import com.intellibitz.muthuselvam.androidapplication.listener.PeopleHeaderListener;
import com.intellibitz.muthuselvam.androidapplication.listener.PeopleListener;
import com.intellibitz.muthuselvam.androidapplication.listener.PeopleTopicListener;
import com.intellibitz.muthuselvam.androidapplication.service.ChatService;
import com.intellibitz.muthuselvam.androidapplication.service.ContactService;
import com.intellibitz.muthuselvam.androidapplication.service.EmailService;
import com.intellibitz.muthuselvam.androidapplication.service.RcvDocService;
import com.intellibitz.muthuselvam.androidapplication.task.GetIpTask;
import com.intellibitz.muthuselvam.androidapplication.task.UpdateGroupTask;
import com.intellibitz.muthuselvam.androidapplication.util.MainApplicationSingleton;
import com.intellibitz.muthuselvam.androidapplication.util.NetworkImageView;
import com.intellibitz.muthuselvam.androidapplication.widget.EditGroupDialogFragment;
import com.intellibitz.muthuselvam.androidapplication.widget.NewBottomDialogFragment;
import com.intellibitz.muthuselvam.androidapplication.widget.NewEmailDialogFragment;
...
import static com.intellibitz.muthuselvam.androidapplication.util.MainApplicationSingleton.ACTIVITY_CONTACTSELECT_RQ_CODE;
import static com.intellibitz.muthuselvam.androidapplication.util.MainApplicationSingleton.ACTIVITY_MSGCHATGRPCONTACTS_RQ_CODE;

//import com.intellibitz.muthuselvam.androidapplication.activity.MsgsGrpNestActivity;

//import com.intellibitz.muthuselvam.androidapplication.feed.ComposeFeedActivity;
//import com.intellibitz.muthuselvam.androidapplication.feed.FeedsFragment;
//import com.intellibitz.muthuselvam.androidapplication.schedule.SchedulesActivity;
...
//            get user from the saved state
        ...
        if (intent != null) {
            ...
            if ("com.intellibitz.muthuselvam.androidapplication.EMAIL_LIST".equals(action)) {
...
//                        invites users to company
        ...
        if (ACTIVITY_CONTACTSELECT_RQ_CODE == requestCode) {
            if (Activity.RESULT_OK == resultCode) {
                if (data != null) {
//                    contacts selected for chat
                    ContactItem contactItem = data.getParcelableExtra(ContactItem.TAG);
...
//            as well as msg thread contact
        ...
        } else if (ACTIVITY_MSGCHATGRPCONTACTS_RQ_CODE == requestCode) {
            if (Activity.RESULT_OK == resultCode) {
                if (data != null) {
//                    contacts selected for chat
                    ContactItem contactItem = data.getParcelableExtra(ContactItem.TAG);
                ...
                if (cursor != null && cursor.getCount() > 0) {
                    ...
                    if (TextUtils.isEmpty(id)) {
                        ...
                        cursor = getContentResolver().query(
                                ...
                                com.intellibitz.muthuselvam.androidapplication.db.MessageItemColumns.KEY_CHAT_ID + " = ? ",
                                new String[]{id}, null
                        );
                        if (cursor != null && cursor.getCount() > 0) {
