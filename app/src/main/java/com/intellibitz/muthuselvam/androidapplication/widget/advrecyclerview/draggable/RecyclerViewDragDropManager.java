...
import com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.utils.CustomRecyclerViewUtils;
...
public class RecyclerViewDragDropManager implements DraggableItemConstants {
    ...
    private com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.BaseEdgeEffectDecorator mEdgeEffectDecorator;
    ...
    private com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.DraggableItemWrapperAdapter mAdapter;
    private DraggingItemInfo mDraggingItemInfo;
    private com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.DraggingItemDecorator mDraggingItemDecorator;
    private com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.SwapTargetItemOperator mSwapTargetItemOperator;
    ...
    public RecyclerViewDragDropManager() {
        mInternalUseOnItemTouchListener = new RecyclerView.OnItemTouchListener() {
            ...
            public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
                return com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.RecyclerViewDragDropManager.this.onInterceptTouchEvent(rv, e);
            }

            @Override
            public void onTouchEvent(RecyclerView rv, MotionEvent e) {
                com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.RecyclerViewDragDropManager.this.onTouchEvent(rv, e);
            }

            @Override
            public void onRequestDisallowInterceptTouchEvent(boolean disallowIntercept) {
                com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.RecyclerViewDragDropManager.this.onRequestDisallowInterceptTouchEvent(disallowIntercept);
            }
        };
        ...
        mInternalUseOnScrollListener = new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.RecyclerViewDragDropManager.this.onScrollStateChanged(recyclerView, newState);
            }

            @Override
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.RecyclerViewDragDropManager.this.onScrolled(recyclerView, dx, dy);
            }
        };
    ...
    private static com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.DraggableItemWrapperAdapter getDraggableItemWrapperAdapter(RecyclerView rv) {
        return WrapperAdapterUtils.findWrappedAdapter(rv.getAdapter(), com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.DraggableItemWrapperAdapter.class);
    }
     ...
     * @return Wrapped adapter which is associated to this {@link com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.RecyclerViewDragDropManager} instance.
     */
    ...
    public RecyclerView.Adapter createWrappedAdapter(@NonNull RecyclerView.Adapter adapter) {
        ...
        mAdapter = new com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.DraggableItemWrapperAdapter(this, adapter);
        ...
        if (supportsEdgeEffect()) {
            ...
            switch (CustomRecyclerViewUtils.getOrientation(mRecyclerView)) {
                case CustomRecyclerViewUtils.ORIENTATION_HORIZONTAL:
                    mEdgeEffectDecorator = new com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.LeftRightEdgeEffectDecorator(mRecyclerView);
                    break;
                case CustomRecyclerViewUtils.ORIENTATION_VERTICAL:
                    mEdgeEffectDecorator = new com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.TopBottomEdgeEffectDecorator(mRecyclerView);
                    break;
            }
    ...
    private void startDragging(RecyclerView rv, MotionEvent e, RecyclerView.ViewHolder holder, ItemDraggableRange range) {
        ...
        mDraggingItemDecorator = new com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.DraggingItemDecorator(mRecyclerView, holder, mDraggableRange);
        ...
        if (supportsViewTranslation() && !mCheckCanDrop &&
            ...
            mSwapTargetItemOperator = new com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.SwapTargetItemOperator(mRecyclerView, holder, mDraggableRange, mDraggingItemInfo);
...
//        }
    ...
    private void handleScrollOnDraggingInternal(RecyclerView rv, boolean horizontal) {
        ...
        final com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.DraggingItemDecorator decorator = mDraggingItemDecorator;
    ...
    private static class ScrollOnDraggingProcessRunnable implements Runnable {
        private final WeakReference<com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.RecyclerViewDragDropManager> mHolderRef;
        private boolean mStarted;

        public ScrollOnDraggingProcessRunnable(com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.RecyclerViewDragDropManager holder) {
        ...
        public void start() {
            ...
            final com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.RecyclerViewDragDropManager holder = mHolderRef.get();
    ...
    private static class InternalHandler extends Handler {
        ...
        private com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.RecyclerViewDragDropManager mHolder;
        private MotionEvent mDownMotionEvent;

        public InternalHandler(com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.RecyclerViewDragDropManager holder) {
            mHolder = holder;
        }
