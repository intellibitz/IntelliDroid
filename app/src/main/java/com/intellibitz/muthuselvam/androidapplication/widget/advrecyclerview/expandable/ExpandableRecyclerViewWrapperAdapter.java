...
import com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.draggable.DraggableItemAdapter;
...
import com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.SwipeableItemAdapter;
import com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.action.SwipeResultAction;
import com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.utils.BaseWrapperAdapter;
import com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.utils.WrapperAdapterUtils;
...
class ExpandableRecyclerViewWrapperAdapter
    ...
    private static final int VIEW_TYPE_FLAG_IS_GROUP = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.VIEW_TYPE_FLAG_IS_GROUP;
    ...
    private com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandablePositionTranslator mPositionTranslator;
    ...
    public ExpandableRecyclerViewWrapperAdapter(RecyclerViewExpandableItemManager manager, RecyclerView.Adapter<RecyclerView.ViewHolder> adapter, int[] expandedItemsSavedState) {
        ...
        mPositionTranslator = new com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandablePositionTranslator();
    ...
    public long getItemId(int position) {
        ...
        final int groupPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionGroup(expandablePosition);
        final int childPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionChild(expandablePosition);

        if (childPosition == RecyclerView.NO_POSITION) {
            final long groupId = mExpandableItemAdapter.getGroupId(groupPosition);
            return com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getCombinedGroupId(groupId);
        } else {
            final long groupId = mExpandableItemAdapter.getGroupId(groupPosition);
            final long childId = mExpandableItemAdapter.getChildId(groupPosition, childPosition);
            return com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getCombinedChildId(groupId, childId);
        }
    }
    ...
    public ItemDraggableRange onGetItemDraggableRange(RecyclerView.ViewHolder holder, int position) {
        ...
        if (childPosition == RecyclerView.NO_POSITION) {
            ...
            if (range == null) {
                ...
                final long startPackedGroupPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionForGroup(range.getStart());
                final long endPackedGroupPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionForGroup(range.getEnd());
            ...
            if (range == null) {
                ...
                final long startPackedChildPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionForChild(groupPosition, childStart);
                final long endPackedChildPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionForChild(groupPosition, childEnd);
    ...
    public boolean onCheckCanDrop(int draggingPosition, int dropPosition) {
        ...
        final int draggingGroupPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionGroup(draggingExpandablePosition);
        final int draggingChildPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionChild(draggingExpandablePosition);
        ...
        final int dropGroupPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionGroup(dropExpandablePosition);
        final int dropChildPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionChild(dropExpandablePosition);
    ...
    public void onMoveItem(int fromPosition, int toPosition) {
        ...
        final int fromGroupPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionGroup(expandableFromPosition);
        final int fromChildPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionChild(expandableFromPosition);

        final long expandableToPosition = mPositionTranslator.getExpandablePosition(toPosition);
        final int toGroupPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionGroup(expandableToPosition);
        final int toChildPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionChild(expandableToPosition);
        ...
        if (fromIsGroup && toIsGroup) {
            ...
            actualToFlatPosition = mPositionTranslator.getFlatPosition(
                    com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionForChild(fromGroupPosition, modToChildPosition));
            ...
            if (fromGroupPosition != toGroupPosition) {
                actualToFlatPosition = mPositionTranslator.getFlatPosition(com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionForGroup(toGroupPosition));
    ...
    public SwipeResultAction onSwipeItem(RecyclerView.ViewHolder holder, int position, int result) {
        ...
        return com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableSwipeableItemInternalUtils.invokeOnSwipeItem(
    ...
    /*package*/ boolean collapseGroup(int groupPosition, boolean fromUser) {
        ...
        if (mPositionTranslator.collapseGroup(groupPosition)) {
            final long packedPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionForGroup(groupPosition);
    ...
    /*package*/ void notifyChildrenOfGroupItemChanged(int groupPosition, Object payload) {
        ...
        if (visibleChildCount > 0) {
            final long packedPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionForChild(groupPosition, 0);
            final int flatPosition = mPositionTranslator.getFlatPosition(packedPosition);
    ...
    /*package*/ void notifyChildItemInserted(int groupPosition, int childPosition) {
        ...
        final long packedPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionForChild(groupPosition, childPosition);
        final int flatPosition = mPositionTranslator.getFlatPosition(packedPosition);
    ...
    /*package*/ void notifyChildItemRangeInserted(int groupPosition, int childPositionStart, int itemCount) {
        ...
        final long packedPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionForChild(groupPosition, childPositionStart);
        final int flatPosition = mPositionTranslator.getFlatPosition(packedPosition);
    ...
    /*package*/ void notifyGroupItemRangeInserted(int groupPositionStart, int count, boolean expanded) {
        ...
        if (insertedCount > 0) {
            final long packedPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionForGroup(groupPositionStart);
            final int flatPosition = mPositionTranslator.getFlatPosition(packedPosition);
