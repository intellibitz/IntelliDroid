...
public class RecyclerViewExpandableItemManager implements ExpandableItemConstants {
    ...
    public RecyclerViewExpandableItemManager(@Nullable Parcelable savedState) {
        mInternalUseOnItemTouchListener = new RecyclerView.OnItemTouchListener() {
            ...
            public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
                return com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.RecyclerViewExpandableItemManager.this.onInterceptTouchEvent(rv, e);
            }
     ...
     * {@link com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.RecyclerViewExpandableItemManager} method can either be a child or group.
     ...
     * @return Wrapped adapter which is associated to this {@link com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.RecyclerViewExpandableItemManager} instance.
     */
    ...
    public void scrollToGroupWithTotalChildrenHeight(int groupPosition, int totalChildrenHeight, int topMargin, int bottomMargin) {
        long packedPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.RecyclerViewExpandableItemManager.getPackedPositionForGroup(groupPosition);
