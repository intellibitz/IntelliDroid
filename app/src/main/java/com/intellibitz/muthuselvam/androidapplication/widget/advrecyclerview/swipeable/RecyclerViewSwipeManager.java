...
public class RecyclerViewSwipeManager implements SwipeableItemConstants {
    ...
    public RecyclerViewSwipeManager() {
        mInternalUseOnItemTouchListener = new RecyclerView.OnItemTouchListener() {
            ...
            public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
                return com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.RecyclerViewSwipeManager.this.onInterceptTouchEvent(rv, e);
            }

            @Override
            public void onTouchEvent(RecyclerView rv, MotionEvent e) {
                com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.RecyclerViewSwipeManager.this.onTouchEvent(rv, e);
            }

            @Override
            public void onRequestDisallowInterceptTouchEvent(boolean disallowIntercept) {
                com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.RecyclerViewSwipeManager.this.onRequestDisallowInterceptTouchEvent(disallowIntercept);
            }
        };
     ...
     * @return Wrapped adapter which is associated to this {@link com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.RecyclerViewSwipeManager} instance.
     */
    ...
    private static class InternalHandler extends Handler {
        ...
        private com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.RecyclerViewSwipeManager mHolder;
        private MotionEvent mDownMotionEvent;

        public InternalHandler(com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.RecyclerViewSwipeManager holder) {
            mHolder = holder;
        }
