...
import com.intellibitz.muthuselvam.androidapplication.bean.MessageBean;
...
import static com.intellibitz.muthuselvam.androidapplication.content.MessageChatContentProvider.createsChatMessageItemFromJSON;
import static com.intellibitz.muthuselvam.androidapplication.content.MessageEmailContentProvider.TABLE_MESSAGEEMAIL_ATTACHMENTS_JOIN;
import static com.intellibitz.muthuselvam.androidapplication.content.MessageEmailContentProvider.createsEmailMessageItemFromJSON;
...
public class MsgsGrpDraftContentProvider extends
    ...
    public static String AUTHORITY = "com.intellibitz.muthuselvam.androidapplication.content.MsgsGrpDraftContentProvider";
    ...
    public static MessageItem savesMsgsGrpDraftFromJSON(
        ...
        if ("EMAIL".equals(msgType)) {
            messageItem = createsEmailMessageItemFromJSON(jsonObject, user);
