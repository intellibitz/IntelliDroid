...
class ExpandablePositionTranslator {
    ...
    public void restoreExpandedGroupItems(
            ...
            com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.RecyclerViewExpandableItemManager.OnGroupExpandListener expandListener,
    ...
    public long getExpandablePosition(int flatPosition) {
        if (flatPosition == RecyclerView.NO_POSITION) {
            return com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.NO_EXPANDABLE_POSITION;
        }
        ...
        long expandablePosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.NO_EXPANDABLE_POSITION;
        ...
        for (int i = startIndex; i < groupCount; i++) {
            ...
            if (offset >= flatPosition) {
                // found (group item)
                expandablePosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionForGroup(i);
                break;
            } else {
                offset += 1;
            }
            ...
            if ((t & FLAG_EXPANDED) != 0) {
                ...
                if ((childCount > 0) && (offset + childCount - 1) >= flatPosition) {
                    // found (child item)
                    expandablePosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionForChild(i, (flatPosition - offset));
                    break;
                } else {
                    offset += childCount;
                }
    ...
    public int getFlatPosition(long packedPosition) {
        if (packedPosition == com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.NO_EXPANDABLE_POSITION) {
            return RecyclerView.NO_POSITION;
        }

        final int groupPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionGroup(packedPosition);
        final int childPosition = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.ExpandableAdapterHelper.getPackedPositionChild(packedPosition);
        final int groupCount = mGroupCount;
