...
import static com.intellibitz.muthuselvam.androidapplication.db.MessageItemColumns.MESSAGECHAT_SCHEMA;
...
public class MsgsGrpPeopleContentProvider extends
    ...
    public static final String CREATE_TABLE_MSGSGRPPEOPLE = "CREATE TABLE "
            + TABLE_MSGSGRPPEOPLE + MESSAGECHAT_SCHEMA;
    ...
    public static final String AUTHORITY = "com.intellibitz.muthuselvam.androidapplication.content.MsgsGrpPeopleContentProvider";
