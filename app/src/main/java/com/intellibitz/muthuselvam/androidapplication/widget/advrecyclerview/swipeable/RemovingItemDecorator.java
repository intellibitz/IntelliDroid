...
class RemovingItemDecorator extends RecyclerView.ItemDecoration {
    ...
    public RemovingItemDecorator(RecyclerView rv, RecyclerView.ViewHolder swipingItem, int result, long removeAnimationDuration, long moveAnimationDuration) {
        ...
        mHorizontal = (result == com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.RecyclerViewSwipeManager.RESULT_SWIPED_LEFT || result == RecyclerViewSwipeManager.RESULT_SWIPED_RIGHT);
    ...
    private static class DelayedNotificationRunner implements Runnable {
        ...
        private WeakReference<com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.RemovingItemDecorator> mRefDecorator;

        public DelayedNotificationRunner(com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.RemovingItemDecorator decorator, int code) {
        ...
        @Override
        public void run() {
            final com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.RemovingItemDecorator decorator = mRefDecorator.get();
            mRefDecorator.clear();
            mRefDecorator = null;
