...
package com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.animator;

import android.view.View;

import com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.animator.impl.AddAnimationInfo;
import com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.animator.impl.ChangeAnimationInfo;
import com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.animator.impl.ItemAddAnimationManager;
import com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.animator.impl.ItemChangeAnimationManager;
import com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.animator.impl.ItemMoveAnimationManager;
import com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.animator.impl.ItemRemoveAnimationManager;
import com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.animator.impl.MoveAnimationInfo;
import com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.animator.impl.RemoveAnimationInfo;
...
public class RefactoredDefaultItemAnimator extends GeneralItemAnimator {
    ...
    protected static class DefaultItemAddAnimationManager extends ItemAddAnimationManager {
        ...
        public DefaultItemAddAnimationManager(com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.animator.BaseItemAnimator itemAnimator) {
            super(itemAnimator);
        }
    ...
    protected static class DefaultItemRemoveAnimationManager extends ItemRemoveAnimationManager {
        ...
        public DefaultItemRemoveAnimationManager(com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.animator.BaseItemAnimator itemAnimator) {
            super(itemAnimator);
        }
    ...
    protected static class DefaultItemChangeAnimationManager extends ItemChangeAnimationManager {
        public DefaultItemChangeAnimationManager(com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.animator.BaseItemAnimator itemAnimator) {
            super(itemAnimator);
        }
