...
package com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.touchguard;
    ...
    public RecyclerViewTouchActionGuardManager() {
        mInternalUseOnItemTouchListener = new RecyclerView.OnItemTouchListener() {
            ...
            public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
                return com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.touchguard.RecyclerViewTouchActionGuardManager.this.onInterceptTouchEvent(rv, e);
            }

            @Override
            public void onTouchEvent(RecyclerView rv, MotionEvent e) {
                com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.touchguard.RecyclerViewTouchActionGuardManager.this.onTouchEvent(rv, e);
            }
