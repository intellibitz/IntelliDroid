...
import com.intellibitz.muthuselvam.androidapplication.content.task.FetchAttachmentsTask;
...
import com.intellibitz.muthuselvam.androidapplication.listener.MainboxListener;
...
//        fragment.setFragmentContext(c);
    ...
    private void showTyping(String toUid, String fromUid, String fromName, ContactItem user) {
        final MessageItem item = getBaseItem(fromUid, attachmentItems);
        if (null == item) {
