...
public class RecyclerViewRecyclerEventDistributor extends BaseRecyclerViewEventDistributor<RecyclerView.RecyclerListener> {
    ...
    private static class InternalRecyclerListener implements RecyclerView.RecyclerListener {
        private final WeakReference<com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.event.RecyclerViewRecyclerEventDistributor> mRefDistributor;

        public InternalRecyclerListener(com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.event.RecyclerViewRecyclerEventDistributor distributor) {
            super();
        ...
        public void onViewRecycled(RecyclerView.ViewHolder holder) {
            final com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.event.RecyclerViewRecyclerEventDistributor distributor = mRefDistributor.get();
