...
public class BaseWrapperAdapter<VH extends RecyclerView.ViewHolder>
    ...
    private static final class BridgeObserver<VH extends RecyclerView.ViewHolder> extends RecyclerView.AdapterDataObserver {
        private final WeakReference<com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.utils.BaseWrapperAdapter<VH>> mRefHolder;

        public BridgeObserver(com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.utils.BaseWrapperAdapter<VH> holder) {
            mRefHolder = new WeakReference<>(holder);
        }

        @Override
        public void onChanged() {
            final com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.utils.BaseWrapperAdapter<VH> holder = mRefHolder.get();
            if (holder != null) {
