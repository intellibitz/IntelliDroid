...
public interface ExpandableItemAdapter<GVH extends RecyclerView.ViewHolder, CVH extends RecyclerView.ViewHolder> {
     ...
     * <p>The combined ID (see {@link com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.RecyclerViewExpandableItemManager#getCombinedGroupId(long)})
     ...
     * {@link com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.RecyclerViewExpandableItemManager#expandGroup(int)} method.
     *
     * @param groupPosition The position of the group item within the adapter's data set
    ...
    /**
     * Called when a group attempt to expand by user operation or by
     * {@link com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.expandable.RecyclerViewExpandableItemManager#collapseGroup(int)} method.
     *
     * @param groupPosition The position of the group item within the adapter's data set
