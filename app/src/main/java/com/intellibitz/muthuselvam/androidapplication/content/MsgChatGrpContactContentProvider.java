...
import com.intellibitz.muthuselvam.androidapplication.db.ContactIntellibitzContactJoinColumns;
...
import static com.intellibitz.muthuselvam.androidapplication.content.DeviceContactContentProvider.createDeviceContact;
import static com.intellibitz.muthuselvam.androidapplication.content.DeviceContactContentProvider.createOrUpdateDeviceContact;
import static com.intellibitz.muthuselvam.androidapplication.content.DeviceContactContentProvider.getDeviceContactsJoin;
import static com.intellibitz.muthuselvam.androidapplication.content.DeviceContactContentProvider.updateDeviceContactJoin;
...
public class MsgChatGrpContactContentProvider extends
    ...
    public static String AUTHORITY = "com.intellibitz.muthuselvam.androidapplication.content.MsgChatGrpContactContentProvider";
        ...
        switch (URI_MATCHER.match(uri)) {
            case CONTACT_DIR_TYPE:
                try {
                    ...
                    long[] ids = createDeviceContact(databaseHelper, deviceContactItems);
