...
public interface SwipeableItemConstants {
     ...
     */
    int REACTION_CAN_NOT_SWIPE_LEFT = (com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.REACTION_CAN_NOT_SWIPE << com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.BIT_SHIFT_AMOUNT_LEFT);
     ...
     */
    int REACTION_CAN_NOT_SWIPE_LEFT_WITH_RUBBER_BAND_EFFECT = (com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.REACTION_CAN_NOT_SWIPE_WITH_RUBBER_BAND_EFFECT << com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.BIT_SHIFT_AMOUNT_LEFT);
     ...
     */
    int REACTION_CAN_SWIPE_LEFT = (com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.REACTION_CAN_SWIPE << com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.BIT_SHIFT_AMOUNT_LEFT);
     ...
     */
    int REACTION_MASK_START_SWIPE_LEFT = (com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.REACTION_MASK_START_SWIPE << com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.BIT_SHIFT_AMOUNT_LEFT);
     ...
     */
    int REACTION_CAN_NOT_SWIPE_UP = (com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.REACTION_CAN_NOT_SWIPE << com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.BIT_SHIFT_AMOUNT_UP);
     ...
     */
    int REACTION_CAN_NOT_SWIPE_UP_WITH_RUBBER_BAND_EFFECT = (com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.REACTION_CAN_NOT_SWIPE_WITH_RUBBER_BAND_EFFECT << com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.BIT_SHIFT_AMOUNT_UP);
     ...
     */
    int REACTION_CAN_SWIPE_UP = (com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.REACTION_CAN_SWIPE << com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.BIT_SHIFT_AMOUNT_UP);
     ...
     */
    int REACTION_MASK_START_SWIPE_UP = (com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.REACTION_MASK_START_SWIPE << com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.BIT_SHIFT_AMOUNT_UP);
     ...
     */
    int REACTION_CAN_NOT_SWIPE_RIGHT = (com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.REACTION_CAN_NOT_SWIPE << com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.BIT_SHIFT_AMOUNT_RIGHT);
     ...
     */
    int REACTION_CAN_NOT_SWIPE_RIGHT_WITH_RUBBER_BAND_EFFECT = (com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.REACTION_CAN_NOT_SWIPE_WITH_RUBBER_BAND_EFFECT << com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.BIT_SHIFT_AMOUNT_RIGHT);
     ...
     */
    int REACTION_CAN_SWIPE_RIGHT = (com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.REACTION_CAN_SWIPE << com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.BIT_SHIFT_AMOUNT_RIGHT);
     ...
     */
    int REACTION_MASK_START_SWIPE_RIGHT = (com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.REACTION_MASK_START_SWIPE << com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.BIT_SHIFT_AMOUNT_RIGHT);
     ...
     */
    int REACTION_CAN_NOT_SWIPE_DOWN = (com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.REACTION_CAN_NOT_SWIPE << com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.BIT_SHIFT_AMOUNT_DOWN);
     ...
     */
    int REACTION_CAN_NOT_SWIPE_DOWN_WITH_RUBBER_BAND_EFFECT = (com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.REACTION_CAN_NOT_SWIPE_WITH_RUBBER_BAND_EFFECT << com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.BIT_SHIFT_AMOUNT_DOWN);
     ...
     */
    int REACTION_CAN_SWIPE_DOWN = (com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.REACTION_CAN_SWIPE << com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.BIT_SHIFT_AMOUNT_DOWN);
     ...
     * <p>If this flag is specified, swipe operation will not start even if user swipe an item to the left direction.</p>
     */
    int REACTION_MASK_START_SWIPE_DOWN = (com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.REACTION_MASK_START_SWIPE << com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.BIT_SHIFT_AMOUNT_DOWN);
     ...
     */
    int REACTION_START_SWIPE_ON_LONG_PRESS = com.intellibitz.muthuselvam.androidapplication.widget.advrecyclerview.swipeable.InternalConstants.REACTION_START_SWIPE_ON_LONG_PRESS;
